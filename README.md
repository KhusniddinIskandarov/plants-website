...
[![v1.1.3](https://img.shields.io/badge/version-v1.1.3-green)](./docs/CHANGELOG.md)
...
- `chore/*` → maintenance and optimization tasks
- `hotfix/*` → targeted bug fixes
...
src/
  ...
  layouts/          — main layout, header and footer wrappers
  modules/          — interactive behavior modules
  pages/            — page sections and page-specific components
...
```bash
git clone https://github.com/KhusniddinIskandarov/plants-website.git
cd plants-website
npm install
npm run dev
```
...
| [DEPLOYMENT.md](./docs/DEPLOYMENT.md)     | Deployment strategy and configuration             |
...
👉 Strong portfolio representation.
