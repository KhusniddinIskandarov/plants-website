...
export function Navbar() {
  return `
    <nav class="container mx-auto px-8 sm:px-6 lg:px-8 flex items-center justify-between h-16 sm:h-20">
      ...
      <div
        id="nav-menu"
        class="absolute overflow-y-auto h-screen py-60 top-0 -left-full min-x-[80px] w-full bg-green-950/80 flex items-center justify-center backdrop-blur-sm duration-300 overflow-hidden lg:static lg:min-h-fit lg:bg-transparent lg:w-auto lg:backdrop-blur-none"
      >
